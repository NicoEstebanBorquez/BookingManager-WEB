    ...
    <body>
        ...
        <jsp:include page="/WEB-INF/paginas/comunes/barraNavegacionPropietarios.jsp"></jsp:include>
            ...
            <div class="container col-8">
                ...
                <!-- FORMULARIO -->
                <form action="${pageContext.request.contextPath}/ControladorPropietarios?accion=InsertarPropietario" method="POST">
                ...
                <div class="row">
                    ...
                    <input class="form-control" type="text" name="inputDomicilio">
                </div>
