    ...
    <body>
        ...
        <jsp:include page="/WEB-INF/paginas/comunes/barraNavegacionClientes.jsp"></jsp:include>
            ...
            <div class="container col-8">
                ...
                <!-- FORMULARIO -->
                <form  action="${pageContext.request.contextPath}/ControladorClientes?id=${clienteSeleccionado.idCliente}" method="POST">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <input class="form-control" type="text" name="inputNombre" value="${clienteSeleccionado.nombre}">
                    </div>
                    <div class="col">
                        <label class="form-label fw-bold" for="inputApellidos">Apellidos:</label>
                        <input class="form-control" type="text" name="inputApellidos" value="${clienteSeleccionado.apellidos}">
                    </div> 
                </div>
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <input class="form-control" type="text" name="inputDni" value="${clienteSeleccionado.dni}">
                    </div>
                    <div class="col">
                        <div>
                            <label class="form-label fw-bold" for="inputPasaporte">Pasaporte:</label>
                            <input class="form-control" type="text" name="inputPasaporte" value="${clienteSeleccionado.pasaporte}">
                        </div>
                    </div>
                    <div class="col">
                        <div>
                            <label class="form-label fw-bold" for="inputNacionalidad">Nacionalidad:</label>
                            <input class="form-control" type="text" name="inputNacionalidad" value="${clienteSeleccionado.nacionalidad}">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <input class="form-control" type="text" name="inputTelefono" value="${clienteSeleccionado.telefono}">
                    </div>
                    <div class="col">
                        <label class="form-label fw-bold" for="inputEmail">Email:</label>
                        <input class="form-control" type="text" name="inputEmail" value="${clienteSeleccionado.email}">
                    </div>
                </div>
