    ...
    <body>
        ...
        <div class="container">
            ...
            <table class="table">
                ...
                <tbody>
                    <c:forEach var="lista" items="${listadoClientes}">
                        <tr>
                            <td>${lista.idCliente}</td> 
                            <td>${lista.nombre} ${lista.apellidos}</td>
                            <td>${lista.dni}</td>
                            <td>${lista.pasaporte}</td>
                            <td>${lista.nacionalidad}</td>
                            <td>${lista.telefono}</td>
                            <td>${lista.email}</td>
                            <td>
                                <a class="btn btn-secondary" href="${pageContext.request.contextPath}/ControladorClientes?accion=Info&id=${lista.idCliente}">Ver más</a>
                            </td>
                        </tr>
                    </c:forEach>
                </tbody>
