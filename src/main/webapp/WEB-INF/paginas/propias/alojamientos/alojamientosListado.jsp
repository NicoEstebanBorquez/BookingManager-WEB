    ...
    <body>
        ...
        <div class="container">
            ...
            <table class="table">
                ...
                <tbody>
                    <c:forEach var="lista" items="${listadoAlojamientos}">
                        <tr>
                            <td>${lista.idAlojamiento}</td> 
                            <td>${lista.nombre}</td>
                            <td>${lista.plazas}</td>
                            <td>${lista.dormitorios}</td>
                            <td>${lista.direccion}</td>
                            <td>${lista.poblacion}</td>
                            <td>${lista.provincia}</td>
                            <td>
                                <a class="btn btn-secondary" href="${pageContext.request.contextPath}/ControladorAlojamientos?accion=Info&id=${lista.idAlojamiento}">Ver más</a>
                            </td>
                        </tr>
                    </c:forEach>
                </tbody>
